 ...
 * @property {{ github: string, twitter: string, telegram: string, medium: string, email: string }} social
 */
...
export const site = {
  ...
  alias: "Zen",
  aliases: ["Zen", "ZenWeb3", "Zen the Developer"],
  roles: [
    "Software Engineer",
  ...
  bioParagraphs: [
    "I'm a software engineer based in Akwa Ibom, Nigeria, working at the intersection of software engineering, developer relations, and Web3 infrastructure. I build applications, SDK demos, developer tooling, and the documentation and tutorials that help other developers onboard faster.",
  ...
  social: {
    ...
    medium: "https://medium.com/@samueledohoeket257",
